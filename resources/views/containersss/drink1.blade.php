...
<head>
    ...
    <link rel="stylesheet" href="/containersss/drink1.css">
...
<body>
    <div class="main1">
        ...
        <div class="conteiner">
            <img src="/FOTO/yellright.png" alt="" class="vekt1">
            <img src="/FOTO/yellleft.png" alt=""class="vekt2">
            ...
            <img src="/FOTO/orange.png" alt="" class="contfoto">
            <div class="cocontblock1">
                <div class="contblock1">
                    <h1 class="maintxt">ORANGE<br>JUICE</h1>
                    <p class="coninftxt">АПЕЛЬСИНОВИЙ СІК НАТУРАЛЬНОГО ВИРОБНИЦТВА.
