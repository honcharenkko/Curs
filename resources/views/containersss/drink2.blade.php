...
<head>
    ...
    <link rel="stylesheet" href="/containersss/drink2.css">
...
<body>
    ...
    @section('content')
        ...
        <div class="conteiner">
            <img src="/FOTO/redright.png" alt="" class="vekt1">
            <img src="/FOTO/redleft.png" alt=""class="vekt2">
            ...
            <img src="/FOTO/granat.png" alt="" class="contfoto">
            <div class="cocontblock1">
                <div class="contblock1">
                    <h1 class="maintxt">GRANAT<br>JUICE</h1>
                    <p class="coninftxt">ГРАНАТОВИЙ СІК НАТУРАЛЬНОГО ВИРОБНИЦТВА.
