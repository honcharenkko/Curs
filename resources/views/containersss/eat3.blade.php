...
<head>
    ...
    <link rel="stylesheet" href="/containersss/eat3.css">
...
<body>
    ...
    @section('content')        
        <div class="conteiner">
            <img src="/FOTO/ylright.png" alt="" class="vekt1">
            <img src="/FOTO/ylleft.png" alt=""class="vekt2">
            ...
            <img src="/FOTO/КАЧКА ГОЧТРА.png" alt="" class="contfoto">
            <div class="cocontblock1">
                <div class="contblock1">
                    <h1 class="maintxt">ШРІМП <br> КАЧКА</h1>
                    <p class="coninftxt">АЗІАТСЬКА РИСОВА ЛОКШИНА З КАЧКОЮ ТА КРЕВЕТКАМИ.  <br> 
                        СКЛАД: КУРКА ФІЛЕ, РИСОВА ЛОКШИНА,ДАЙКОН, ЦИБУЛЯ РІПЧАСТА, МОРКВА, ЯЙЦЯ, ПЕРЕЦ ЧИЛІ, КОРЕНЬ ІМБИРУ, ПІР’ЇН ЗЕЛЕНОЇ ЦИБУЛІ, ЛИМОН,СІЛЬ,СОНЯШНИ<br>КОВА ОЛІЯ.</p>  
                </div>
            </div>
        </div>
        <div class="blocktxt">
