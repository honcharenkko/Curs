...
<head>
    ...
    <link rel="stylesheet" href="/containersss/drink4.css">
...
<body>
    ...
    @section('content')
        <div class="conteiner">
            <img src="/FOTO/grright.png" alt="" class="vekt1">
            <img src="/FOTO/grleft.png" alt=""class="vekt2">
            ...
            <img src="/FOTO/apple.png" alt="" class="contfoto">
            <div class="cocontblock1">
                <div class="contblock1">
                    <h1 class="maintxt">APPLE<br>JUICE</h1>
                    <p class="coninftxt">ЯБЛУЧНИЙ СІК НАТУРАЛЬНОГО ВИРОБНИЦТВА.
                        БЕЗ БАРВНИКІВ ТА КОНСЕРВАНТІВ.
                        У 100 г свіжого апельсинового соку міститься майже вся добова норма вітамінних запасів, а це:                                                                        
                        <br> • вітамін В1, В2 0,01 мг
                        <br> • вітамін В5 0,07 мг. 
                        <br> • вітамін В6 0,08 мг. 
                        <br> • вітамін В9 2 мкг.</p>  
                </div>
            </div>
        </div>
        <div class="blocktxt">
