...
<head>
    ...
    <link rel="stylesheet" href="/containersss/telsale2.css">
...
<body>
    ...
    @section('content1')
        ...
        <div class="top">
            <img src="/FOTO/ГЛАВНАЯ АКЦИЯ.png" alt="" class="topfoto">
        </div>
        <div class="info">
            <div class="middle">
            ...
            <div class="right">
                <div class="infoborder1">
                    <h1 class="righttxt">ШАЛЕНИЙ
                        ЧЕТВЕР</h1>
                    <p class="inforight">КОЖЕН ЧЕТВЕРГ ВИ МОЖЕТЕ ПРИДБАТИ 2 ЛОКШИНИ ТА НА ДРУГУ БУДЕ ЗНИЖКА 50%
