...
<head>
    ...
    <link rel="stylesheet" href="/containersss/teldrink2.css">
...
<body>
    <div class="telephone">
    @section('content1')
        <img src="/FOTO/drink21.png" alt="" class="vector1">
        <img src="/FOTO/drink22.png" alt="" class="vector2">
        <div class="top">
            <img src="/FOTO/grape.png" alt="" class="topfoto">
        </div>
        <div class="info">
            <div class="left">
                <div class="infoborder">
                    ...
                    <h1 class="infotxt1">76</h1>
                    <h1 class="infotxt">виноград</h1>
                    <img src="/FOTO/free-icon-grapes-1140275.png" alt="" class="infoimg">
                </div>
            </div>
            <div class="right">
                <div class="infoborder1">
                    <h1 class="righttxt">GRAPE
                        JUICE</h1>
                    <p class="inforight">ВИНОГРАДНИЙ СІК НАТУРАЛЬНОГО ВИРОБНИЦТВА.
                        БЕЗ БАРВНИКІВ ТА КОНСЕРВАНТІВ.
                        У 100 г свіжого апельсинового соку міститься майже вся добова норма вітамінних запасів, а це:
                        вітамін В1, В2 0,14 мг.
                        вітамін В2 0,9 мг. 
                        вітамін В6 1,11 мг. 
                        вітамін В7 5 мкг. `</p>
                </div>
